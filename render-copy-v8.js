// Sending a memoed child component a property by value, won't re-render the child component
...
function App() {
  ...
  return <div className="App box">
    ...
    <ComponentA borderRadiusProp={borderRadiusValue} />
  </div>
}

const ComponentA = memo(function ComponentA({ borderRadiusProp }) {
  const [stateA, setStateA] = useState(0);
  return <div className="box" style={{ borderRadius: borderRadiusProp }}>
    <Rerender />
    <h3 style={{ color: "green" }}>memo(Child)</h3>
    <p>StateChild received a borderRadius of {borderRadiusProp}px</p>
