// Sending a memoed child component a property everytime as new object, re-render the child component
...
function App() {
  ...
  const borderRadiusReference = { borderRadius: "25px" };
  ...
  return <div className="App box">
    ...
    <ComponentA borderRadiusProp={borderRadiusReference} />
  </div>
}
